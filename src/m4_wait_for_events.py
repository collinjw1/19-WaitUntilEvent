...
def sum_until_prime_input():
    ...
    summ=0
    while True:
        numnum=int(input('Insert integer greater than 1:  '))
        summ = summ + numnum
        if is_prime(numnum) == True:
            break


    print('The sum of the input integers is:',summ)
...
def run_test_wait_for_sum_of_cubes():
    ...
    print('TEST STARTED!  Has it ended?')
    expected = 4
    actual = wait_for_sum_of_cubes(67)
    print('Expected:', expected)
    print('Actual:  ', actual)
    print('TEST ENDED!')
    ...
    print('TEST STARTED!  Has it ended?')
    expected = 10
    actual = wait_for_sum_of_cubes(2650)
    print('Expected:', expected)
    print('Actual:  ', actual)
    print('TEST ENDED!')
...
def wait_for_sum_of_cubes(x):
    ...
    beanstalk=0
    while True:
        beanstalk = beanstalk + magicbean ** 3
        if beanstalk >= x:
            break
