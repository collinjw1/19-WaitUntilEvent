...
def double_a_float():
    ...
    # ------------------------------------------------------------------
    num=float(input('Please insert floating point number.'))
    print(num * 2)
...
def input_it_all():
    ...
    #   The testing code is already written for you (above).
    # ------------------------------------------------------------------
    flopo = float(input('Insert floating point number: '))
    integrr = int(input('Insert integer: '))
    sting = str(input('Insert string: '))
    rooflo = flopo ** 0.5

    for k in range(integrr):
        print(rooflo)
